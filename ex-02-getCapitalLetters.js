...
var newArray = [];
	...
	for (i=0; i<arrayText.length; i++){
		for(j=0; j<arrayText[i].length; j++) {
			
			if(arrayText[i][j] === arrayText[i][j].toUpperCase()){
				// console.log(arrayText[2][0]);
				newArray.push(arrayText[i][j]);
 ...
 // console.log(arrayText[1][0] + " " + arrayText[1][0].toUpperCase());
}
